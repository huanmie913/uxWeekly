...
areas = {
		  ...
		  '广州':('gz',7, 2454, 1814, '广东'), 
		  '哈尔滨':('heb',5,2918,470,'黑龙江'),
		  '长春':('cc',5,2834,592,'吉林'),
		  '沈阳':('sy',5,2798,742,'辽宁'),
		  '石家庄':('sjz',7,2484,976,'河北'),
		  '太原':('ty',5,2368,994,'山西'),
		  '西宁':('xn',3,1892,1060,'青海'),
		  '济南':('jn',7,2602,1040,'山东'),
		  '郑州':('zz',5,2456,1162,'河南'),
		  '南京':('nj',6,2714,1286,'江苏'),
		  '合肥':('hf',6,2626,1320,'安徽'),
		  '杭州':('hz',7,2766,1362,'浙江'),
		  '南昌':('nc',6,2564,1492,'江西'),
		  '长沙':('cs',6,2430,1526,'湖南'),
		  '武汉':('wh',6,2502,1396,'湖北'),
		  '海口':('hk',6,2302,1986,'海南'),
		  '兰州':('lz',3,1998,1090,'甘肃'),
		  '西安':('xa',5,2220,1110,'陕西'),
		  '成都':('cd',4,2022,1374,'四川'),
		  '贵阳':('gy',5,2142,1630,'贵州'),
		  '昆明':('km',5,1936,1718,'云南'),
		  '台北':('tb',3,2876,1654,'台湾')
        }
