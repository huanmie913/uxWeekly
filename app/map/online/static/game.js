...
(function(win,undefined){
    ...
    //省市热度
    gameIndex.initArea = function(jsonData){
        var provinceArea = {}
        ...
        provinceArea.colorDepth = function(obj){
           ...
           gameIndex.$(_proNameId).style.opacity = _opacity;   
        };
    ...
    gameIndex.initPop = function(jsonData){
        ...
        gamePop.tpl = function(obj){
            ...
            var _html = doc.createElement("div");
                ...
                _str = '<ul>';
                _str += '<li><img id="imgSrc" src="'+obj['icon']+'"/><span id="imgName">'+obj['game']+'</span></li>';
                _str += '<li>'+obj['province']+'</li></ul>';
        ...
        gamePop.rendHtml = function(data){
            ...
            if(gameIndex.$(_provinceName+"_pop") != null){
                ...
                if( _parentNode !=null){
                    ...
                    var _html = gamePop.tpl({'game':_ngameName,'province':_provinceName,'icon':_ngameIcon,'pos':_position});
                }
            }else{
                var _gameName = data['game'],
                    _gameIcon = data['icon'];
                var _html = gamePop.tpl({'game':_gameName,'province':_provinceName,'icon':_gameIcon,'pos':_position});   
            }
    ...
    gameIndex.initNum = function(){
            var updateNum = {};
            var _num = _initNum;
            updateNum.localStorage = function(){};
